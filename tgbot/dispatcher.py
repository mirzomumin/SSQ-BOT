...
from tgbot.handlers.question import handlers as question_handlers
...
def setup_dispatcher(dp):
    ...
    dp.add_handler(CommandHandler("send_anonimous_question", question_handlers.send_anonimous_question))
    dp.add_handler(MessageHandler(Filters.text & (~Filters.command), question_handlers.handle_text_message))
